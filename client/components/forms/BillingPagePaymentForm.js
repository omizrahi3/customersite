...
class BillingPagePaymentForm extends React.Component {
  state = {
    data: {
      Fullname: '',
      Cardnumber: '',
  ...
  componentDidMount() {
    console.log('BillingPagePaymentForm did mount');
    const years = [];
  ...
  render() {
    const { fetchedCard, errors, hasCard } = this.state;
          ...
          <Form onSubmit={this.onSubmit}>
            {errors.server && (
              ...
              <Form.Field
                ...
                name="cardholderName"
                value={fetchedCard.cardholderName}
              />
              <Form.Field
                disabled
                width={12}
                ...
                label='CARD NUMBER*'
                name="maskedNumber"
                value={fetchedCard.maskedNumber}
              />
...
BillingPagePaymentForm.propTypes = {
...
export default connect(mapStateToProps)(BillingPagePaymentForm);